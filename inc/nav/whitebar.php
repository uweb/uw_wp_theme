...
class UW_Dropdowns
{
	...
	function set_uw_menu_location()
	{
	 ...
	 function generate_menu_list()
	 {
		...
		$this->add_menu_item( 'Academics at the UW', 'https://www.washington.edu/about/academics/', $parent = 'Academics' );
		...
		$this->add_menu_item( 'Research at the UW', 'https://www.washington.edu/research/', $parent = 'Research' );
