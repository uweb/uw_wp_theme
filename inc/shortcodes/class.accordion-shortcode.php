...
class UW_Accordion
{
    ...
    function accordion_handler( $atts, $content )
    {
        ...
        return sprintf( '<div id="uw-accordion-shortcode"><h3>%s</h3><div class="js-accordion" data-accordion-prefix-classes="uw-accordion-shortcode">%s</div></div>', $accordion_atts['name'], $output );
	}
