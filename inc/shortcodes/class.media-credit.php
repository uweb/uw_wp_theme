...
class UW_Media_Credit
{
  ...
  function __construct()
  {
    ...
    add_filter( 'image_send_to_editor', array( $this, 'mediacredit_tinymce_html'), 10, 8 );
  ...
  function mediacredit_tinymce_html( $html, $id, $caption, $title, $align, $url, $size, $alt, $rel )
  {
    if ( $caption )
      return $html;
