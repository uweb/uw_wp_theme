...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  */
	if (parentMenuItemToggled) {
		...
		toggleButton.setAttribute('aria-label', uw_goldenScreenReaderText.expand);
		...
		toggleButton.setAttribute('aria-label', uw_goldenScreenReaderText.collapse);
	}
}
...
function getDropdownButton() {
	...
	dropdownButton.setAttribute('aria-label', uw_goldenScreenReaderText.expand);
