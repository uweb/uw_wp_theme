 ...
 */
function uw_golden_quicklinks() {
	add_action( 'wp_enqueue_scripts', 'uw_golden_enqueue_quicklinks' );
}
add_action( 'wp', 'uw_golden_quicklinks' );

/**
 * Enqueue and defer quicklinks scripts.
 */
function uw_golden_enqueue_quicklinks() {
	if ( is_multisite() ) {
		wp_enqueue_script( 'uw_golden-quicklinks-script', network_site_url( '/wp-content/themes/uw_golden/pluggable/quicklinks/quicklinks.js' ), array( 'underscore', 'uw_golden-backbone' ), '20190703', true );
		wp_enqueue_style( 'uw_golden-quicklinks-style', network_site_url( '/wp-content/themes/uw_golden/pluggable/quicklinks/quicklinks.css' ), array(), '20190705' );
	} else {
		wp_enqueue_script( 'uw_golden-quicklinks-script', get_theme_file_uri( '/pluggable/quicklinks/quicklinks.js' ), array( 'underscore', 'uw_golden-backbone' ), '20190703', true );
		wp_enqueue_style( 'uw_golden-quicklinks-style', get_theme_file_uri( '/pluggable/quicklinks/quicklinks.css' ), array(), '20190705' );
	}
}
