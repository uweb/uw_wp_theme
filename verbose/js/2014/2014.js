...
var root = window.document; // Create a safe reference to the UW object which will be used to establish the global UW object.
...
root.UW = UW; // Current version

UW.VERSION = '0.1'; // Constant for legible keycodes
