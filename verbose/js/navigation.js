...
function initMainNavigation() {
  ...
  var SUBMENUS = SITENAV.querySelectorAll('.menu ul'); // No point if no submenus.
...
function initMenuToggle() {
  var MENUTOGGLE = SITENAV.querySelector('.menu-toggle'); // Return early if MENUTOGGLE is missing.
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  var parentMenuItemToggled = parentMenuItem.classList.contains('toggled-on'); // Will be true if we want to force the toggle on, false if force toggle close.
