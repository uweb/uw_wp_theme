  ...
  if ($accordions.length) {
    ...
    $accordions.each(function (index) {
      ...
      $accordions_headers.each(function (index_h) {
        ...
        $accordion_panel.attr({
          ...
          "aria-hidden": "true"
        }).addClass($accordions_prefix_classes + "__panel"); //console.log($accordion_panel.attr("data-accordion-opened"));
    ...
    $("body").on("focus", ".js-accordion__header", function (event) {
      var $this = $(this),
          ...
          $all_accordion_headers = $accordion.find(".js-accordion__header"); // selected
      ...
      $this.attr("aria-selected", "true"); // opened or closed?
      ...
      var $this = $(this),
          ...
          $next_header = $this.nextAll(".js-accordion__header").first(); // strike up or left in the tab => previous tab
      ...
      var $this = $(this),
          ...
          $last_header = $accordion.find(".js-accordion__header").last(); // strike up + ctrl => go to header
